...
import './PandeAboutSection3.css'; 

const PandeAboutSection3 = () => {
      ...
      <Container>
        <Row>
          <Col md={8}>
            ...
            <div>
              <strong>Name:</strong> Prof. R.K.Sahare
            </div>
            <div>
              <strong>Designation:</strong> Assistant Professor </div>
            <div>
              <strong>Qualification:</strong> M.E. (CSE)
            </div>

            <div>
              <strong>Experience:</strong> 09 Years
            </div>

            <div>
              <strong>Email:</strong> rekhasahare@gcoec.ac.in
            </div>

            <p style={textStyle}>
              As an Assistant Professor Rekha Sahare at our esteemed institution, I am dedicated to shaping the future of our students by imparting knowledge, fostering critical thinking, and nurturing academic growth. My passion for education and commitment to excellence drive me to provide the best learning experience for my students.
...
export default PandeAboutSection3;
